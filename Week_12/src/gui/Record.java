...
// Attributes
  ...
  ***/
  ...
  // Associations
  private Record family = null;

  // Constructor
  public Person(Record fam, String f, String l) {
    firstName = f;
    lastName = l;
    family = fam;
    if ( family != null ) {
...
//**************************
 class WriteFamilies {
  public static void main(String[] args) {
    Record family1 = new Record();
    Record family2 = new Record();
    Record family3 = new Record();
 ...
 class ReadFamilies {
	...
	public static void main(String[] args) {
		...
		try {
			 ...
			 ***/
			family1 = (Record) objectInputStream.readObject();
			family2 = (Record) objectInputStream.readObject();
			family3 = (Record) objectInputStream.readObject();
